# Business Model: Travel Agency Booking Coordination
...
## Classification
- Repository: `cloud-itonami-isic-791` ([github.com/cloud-itonami/cloud-itonami-isic-791](https://github.com/cloud-itonami/cloud-itonami-isic-791))
- ISIC Rev.5: `791` — Travel Agency Booking Coordination
- Domain: `:travel/booking-coordination`
- Social impact: :accessible-travel :tourism-support :community-connectivity
- Actor: `:travel-agency-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :travel/booking-coordination — who wants
a governed execution scaffold they own instead of renting a closed SaaS.

## Offer
The actor coordinates the :intake :register :match :dispatch :follow-up :audit pipeline behind an independent Governor: the
...
Capability stack (required): :identity :forms :audit-ledger :telemetry.
...
One managed tenant (:travel/booking-coordination):
...
- Do not bypass the `:travel-agency-governor` for production decisions.
